      ...
      <v-row>
        ...
        >
          ...
          >
            ...
            <v-card-actions
              class="pa-0 justify-space-between align-center mb-7"
            >
              <v-btn
                height="45"
                color="rgb(83 79 214)"
              ...
              <v-btn
                ...
                class="flex-grow-1"
              >
                <svg width="70" height="17" xmlns="http://www.w3.org/2000/svg">
            ...
            <v-card-title class="Shipping-Addresses font-weight-bold py-0">
              Shipping Addresses
            </v-card-title>
            <v-select
              class="w-100 mt-10 pa-0 rounded"
              label="Country / Regions"
              :items="countries"
            ></v-select>

            <div
              class="user_name px-0 d-flex align-center justify-center"
              v-gap="'15px'"
            >
              <v-text-field
                label="First Name"
                class="w-100 pa-3 rounded px-0"
              ></v-text-field>
              <v-text-field
                label="Last Name"
                class="w-100 pa-3 rounded px-0"
            ...
            <v-text-field
              label="Addresses"
              class="w-100 mt-0 rounded Addresses"
            ></v-text-field>

            <v-text-field
              label="Appartment"
              class="w-100 mt-2 mb-5 rounded Appartment"
            ></v-text-field>
            ...
            <v-divider length="100%" color="black"></v-divider>
            <v-card-text>
              <span style="color: #7b7b7b">All rights reserved </span>
              <a
                href="https://www.linkedin.com/in/mahmod11/"
                style="text-decoration: auto; color: #6f6f6f; font-weight: bold"
              >
                Mahmoud Mostafa
              </a>
            </v-card-text>
        ...
        >
          <v-card elevation="0" class="card-parent">
            ...
            >
              ...
              <v-card-text class="flex-grow-0 price">
                ${{
                  Math.ceil(
...
::v-deep .v-field__outline::before {
  content: none;
}
